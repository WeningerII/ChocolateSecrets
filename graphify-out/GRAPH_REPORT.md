...
Cohesion: 0.05
Nodes (63): BillPaymentHistory(), BillPaymentHistoryProps, BillReview(), BillReviewProps, BillsListProps, BillUpload(), BillUploadProps, PaymentForm() (+55 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (64): DIFFUSANTS, FREEZE_ENV, FREEZE_ENVS, GEOMETRIES, METHODS, SURFACE_BY_METHOD, TransportPanelProps, BrineParams (+56 more)
...
Cohesion: 0.07
Nodes (34): EditorFrozenStrip(), EditorFrozenStripProps, EditorPhysicsRibbon(), EditorPhysicsRibbonProps, RecipeFrozenTier(), RecipeFrozenTierProps, RecipePhysicsTier(), RecipePhysicsTierProps (+26 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (37): DisplayWarning, RecipeWarningsList(), RecipeWarningsListProps, Severity, PhysicsWarning, ConfectioneryWarning, FROZEN_BANDS_BY_SUBTYPE, POD_FACTORS (+29 more)

### Community 5 - "Community 5"
Cohesion: 0.10
Nodes (38): EditorBreadStrip(), EditorBreadStripProps, RecipeBreadTier(), RecipeBreadTierProps, calculateBakersPct(), flourSubtype(), isFlour(), isSalt() (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (33): Dashboard(), bonbonRecipe, fixtureIngredients, fixtureRecipes, subRecipeGanache, subRecipeTemperedDark, ContributionReport, contributionsFromLeaves() (+25 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (27): RuntimeTranslated(), TranslateRecipeModal(), TranslateRecipeModalProps, RuntimeTranslationState, TranslationStatus, useRuntimeTranslation(), applyTranslationProposal(), collectTasks() (+19 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (30): assessCurdleRisk(), assessEthanol(), LONG_SHELF_ETHANOL_BAND, evaluateConfectionery(), classify(), computeChocolateSnap(), computePolymorphWindow(), detectMixedChocolateClasses() (+22 more)

### Community 9 - "Community 9"
Cohesion: 0.10
Nodes (27): ActionIcon(), ActionIconProps, actionMap, BillsList(), ConfirmModalProps, LocalizedField(), LocalizedFieldProps, resolveLocalized() (+19 more)

### Community 10 - "Community 10"
Cohesion: 0.20
Nodes (25): AuditsView(), ReceivePOModal(), TransfersView(), DataContext, DataProvider(), useData(), app, auth (+17 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (33): BatchImportReview(), BatchImportReviewProps, NewIngredientDraft, VisualAuditModal(), ACTION_TYPES, CANONICAL_UNITS, COMPONENT_TYPES, INGREDIENT_CATEGORIES (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (26): detectHardConstraintViolation(), evaluateObjectives(), RISK_RANK, scoreCandidate(), BLISS, BlissTaste, clamp(), computePalatability() (+18 more)

### Community 13 - "Community 13"
Cohesion: 0.13
Nodes (25): EvalInput, compareNumbers(), DslContext, evaluateStepCondition(), formatNumeric(), readPhysicsMetric(), renderStepTemplate(), resolveSlot() (+17 more)

### Community 14 - "Community 14"
Cohesion: 0.13
Nodes (22): AdjustStockModal(), AdjustStockModalProps, AuditsViewProps, ReceiveGoodsModalProps, TransferStockModal(), TransferStockModalProps, TransfersViewProps, Props (+14 more)

### Community 15 - "Community 15"
Cohesion: 0.16
Nodes (22): RECIPE_TYPES, AllergenKey, ExtractedRecipe, AllergenFlag, CrossContactRisk, DietaryFlag, HACCPMetadata, MixingMethod (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.11
Nodes (22): ChocolateContent(), formatRange(), IngredientInfo(), IngredientInfoProps, lookupTemperingCurve(), parseChocolateSpec(), DAIRY_BRANDS, DAIRY_CATEGORIES (+14 more)

### Community 17 - "Community 17"
Cohesion: 0.10
Nodes (19): PAC_FACTORS, BOILING_SOLUTES, BoilingFlag, BoilingResult, CANDY_STAGES, CandyStage, classifyCandyStage(), computeBoilingPoint() (+11 more)
...
Cohesion: 0.21
Nodes (14): Combobox(), ComboboxProps, ReceiveGoodsModal(), IngredientDetail(), Ingredients(), deriveIngredientDietaryFlags(), SafeBatch, sanitizeData() (+6 more)

### Community 20 - "Community 20"
Cohesion: 0.13
Nodes (17): OpDef, caramelize(), CaramelizeParams, SUGAR_ONSET, chill(), ChillParams, heat(), HeatParams (+9 more)

### Community 21 - "Community 21"
Cohesion: 0.12
Nodes (19): RoleBadge(), RoleBadgeProps, CATEGORY_FALLBACK, getRoleSwapSet(), has(), hasNot(), InferenceRule, inferRole() (+11 more)

### Community 22 - "Community 22"
Cohesion: 0.17
Nodes (20): react, react, completed, hasMissingTranslations(), inFlight, useAutoTranslate(), RecipeCookingMode(), RecipeDetail() (+12 more)
...
Cohesion: 0.10
Nodes (21): date-fns, express, i18next-browser-languagedetector, motion, dependencies, date-fns, express, i18next-browser-languagedetector (+13 more)

### Community 26 - "Community 26"
Cohesion: 0.20
Nodes (16): CompositionEditor(), DosingPanel(), alcoholComposition(), chocolateComposition(), COMPOSITION_DESCRIPTORS, COMPOSITION_SPECIES, compositionSum(), DEFAULT_COMPOSITION_BY_CATEGORY (+8 more)

### Community 27 - "Community 27"
Cohesion: 0.14
Nodes (14): FailureModeSheet(), FailureModeSheetProps, FailureModeTrigger(), FailureModeTriggerProps, CHOCOLATE_CATALOG, CHOCOLATE_FAILURE_MODES, CHOCOLATE_WORK_ACTION_TYPES, ChocolateProductEntry (+6 more)

### Community 28 - "Community 28"
Cohesion: 0.21
Nodes (15): add(), Enzyme, EnzymeFlag, EnzymeParams, ENZYMES, CULTURES, ferment(), FERMENTABLE (+7 more)

### Community 29 - "Community 29"
Cohesion: 0.13
Nodes (16): setGel(), SetGelParams, SUGARS, FunctionalAgent, PATTERNS, resolveFunctionalAgent(), CoFactor, cofactorMet() (+8 more)
...
Cohesion: 0.21
Nodes (12): BarcodeScannerModal(), Props, Props, ReceiptImportModal(), useRestaurantSettings(), Recipes(), newDocRef(), prepareImageForUpload() (+4 more)

### Community 33 - "Community 33"
Cohesion: 0.20
Nodes (15): getActionIcon(), RecipeEditor(), Action, RecipeEditorProps, getConfidenceStyle(), getFieldMeta(), getIngredientMinConfidence(), getProvenanceStyle() (+7 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (16): TransportPanel(), deriveWarnings(), CLASSIC_GANACHE, DARK_70, HEAVY_CREAM, RASPBERRY_PUREE, useRecipePhysics(), classifyBand() (+8 more)

### Community 35 - "Community 35"
Cohesion: 0.16
Nodes (11): locales, localizer, ProductionCalendarProps, ALL_ALLERGEN_KEYS, RestaurantSettings(), PrepItem, ProductionRun, Restaurant (+3 more)
...
Cohesion: 0.16
Nodes (15): CompositionEditorProps, AddParams, EnzymeProfile, CultureProfile, classifyBand(), computeDoneness(), DonenessBand, DonenessFlag (+7 more)

### Community 38 - "Community 38"
Cohesion: 0.16
Nodes (11): CsvImportModal(), CsvImportModalProps, Toast, ToastContext, ToastContextValue, ToastProvider(), ToastVariant, useToast() (+3 more)

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (13): DosingPanelProps, TASTES, DosingAddition, DosingFlag, DosingGoal, DosingOptions, DosingPoint, DosingResult (+5 more)
...
Cohesion: 0.23
Nodes (12): dehydrate(), DehydrateFlag, DehydrateParams, computeDryingRate(), DryingFlag, DryingRateInput, DryingRateResult, computePsychrometrics() (+4 more)
...
Cohesion: 0.27
Nodes (11): accumulateThermalExtent(), arrheniusRate(), awSuitability(), classifyBand(), computeLipidOxidation(), OxidationBand, OxidationFlag, REF_FAT_FACTOR (+3 more)
...
Cohesion: 0.21
Nodes (9): RecipeCategoryPicker(), RecipeCategoryPickerProps, BREAD_RECIPE_SUBTYPES, DEFAULT_FRICTION_FACTOR_BY_METHOD, FROZEN_RECIPE_SUBTYPES, MIXING_METHODS, RECIPE_CATEGORIES, RecipeCategory (+1 more)

### Community 55 - "Community 55"
Cohesion: 0.30
Nodes (9): ALLERGEN_LABELS, ALLERGEN_PATTERNS, AllergenCertainty, deriveAllergens(), identifyCrossContactRisks(), computeCrossContactRisks(), crossContactRisksEqual(), normalizeRisks() (+1 more)

### Community 56 - "Community 56"
Cohesion: 0.26
Nodes (10): zValueRate(), awSuitability(), classifyBand(), computeMaillardBrowning(), MaillardBand, MaillardFlag, reducingSugarPct(), saturating() (+2 more)

### Community 57 - "Community 57"
Cohesion: 0.27
Nodes (8): longStorage, FATTY, refStorage, buildProcessProfile(), finalizeProfile(), profileFromSegments(), ProcessSegment, RecipeStep
...
Cohesion: 0.40
Nodes (6): AlertsBell(), SEVERITY_DOT, dismissAlert(), Alert, alertCreatedMillis(), selectActiveAlerts()

### Community 62 - "Community 62"
Cohesion: 0.29
Nodes (7): Layout(), PageSpinner(), RequireAdmin(), RequireAdminProps, logOut(), signInAsGuest(), useUserRole()

### Community 63 - "Community 63"
Cohesion: 0.33
Nodes (8): PurchaseOrderModal(), PurchaseOrderModalProps, ReceivePOModalProps, PurchaseOrder, PurchaseOrderItem, ShoppingListItem, Supplier, formatIdentifier()

### Community 64 - "Community 64"
Cohesion: 0.31
Nodes (7): brine(), BrineFlag, BrineSolute, freeze(), FreezeFlag, computePlankTime(), computeFreezing()

### Community 65 - "Community 65"
Cohesion: 0.27
Nodes (7): emulsify(), EmulsifyParams, STABILITY_SCORE, temper(), TemperParams, computeEmulsion(), EmulsionStability

### Community 66 - "Community 66"
Cohesion: 0.22
Nodes (8): FormulaBalanceFlag, FormulaBalanceMasses, FormulaBalanceRatios, FormulaFault, FormulaFaultKind, FormulaFaultSeverity, balancedCake(), leaf()

### Community 67 - "Community 67"
Cohesion: 0.24
Nodes (8): BUFFALO_MILK, CAMEL_MILK, dehydrate(), GOAT_MILK, REINDEER_MILK, SHEEP_MILK, USDA_FDC_SNAPSHOT, UsdaFdcEntry
...
Cohesion: 0.40
Nodes (3): EmulsionFlag, EmulsionInput, EmulsionType

### Community 83 - "Community 83"
Cohesion: 0.50
Nodes (3): AlertSeverity, AlertType, RecurringCadenceTolerance

## Knowledge Gaps
- **469 isolated node(s):** `name`, `build`, `test`, `serve`, `shell` (+464 more)
...
- **Why does `dependencies` connect `Community 25` to `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 101`, `Community 102`, `Community 103`, `Community 77`, `Community 86`, `Community 87`, `Community 22`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `react` connect `Community 22` to `Community 32`, `Community 25`, `Community 80`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `RecipeDetail()` connect `Community 22` to `Community 32`, `Community 34`, `Community 35`, `Community 38`, `Community 6`, `Community 9`, `Community 10`, `Community 13`, `Community 19`, `Community 55`?**
