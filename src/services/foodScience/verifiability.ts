...
export const QUALITY_DIMENSIONS: readonly QualityDimension[] = [
  ...
  { id: 'maillard_browning', category: 'composition', predictability: 'calibrated', measurability: { instrument: 'GC-MS / colorimeter' }, computedBy: null, notes: 'Gap: needs a temperature·time process model.' },
  ...
  // --- Thermal & transport ---
  { id: 'heat_transfer_doneness', category: 'transport', predictability: 'calibrated', measurability: { instrument: 'thermocouple' }, computedBy: null, notes: 'Gap: bread DDT is static, no T·time integral.' },
